/*
 * Original code from OpenDroidChat
 * Copyright (C) 2025-2026 HOE Team. All rights reserved.
 * Licensed under MIT License. See LICENSE-MIT file for details.
 *
 * This file is part of KryptonAgent, which is licensed under GPL v3.
 * As permitted by MIT License, this code is used in a GPL v3 project.
 * The above copyright notice and MIT license notice must be retained.
 */

/*
 * Modifications for KryptonAgent
 * Copyright (C) 2026 DCR Studio
 *
 * SPDX-License-Identifier: GPL-3.0 WITH MIT-exception
 */
package com.dcr.krag.network

import com.dcr.krag.data.*
